...
TEST(ChromeResponseUtils, VerifyMinimalResponseEncoding) {
  ...
  EXPECT_THAT(
      ...
      testing::StrEq(
          ...
          "65722d6164746563682e636f6d766d6963726f736f667457696e6e657249734b416e"
          "6f6ef478196b416e6f6e57696e6e65724a6f696e43616e64696461746573a36f6164"
          ...
          "81450504030201781a6b416e6f6e57696e6e6572506f736974696f6e616c496e6465"
          "7805"));
}
...
TEST(ChromeResponseUtils, VerifyMinimalResponseEncodingWithBuyerReportingId) {
  ...
  *top_level_contributions = std::move(responses);
  ...
  EXPECT_THAT(
      absl::BytesToHexString(*ret),
      testing::StrEq(
          "ad63626964fa3f9ae1486573636f7265fa401666666769734368616666f46a636f6d"
          ...
          "72781868747470733a2f2f62757965722d6164746563682e636f6d766d6963726f73"
          "6f667457696e6e657249734b416e6f6ef4"));
}
...
TEST(ChromeResponseUtils, VerifyMinimalComponentResponseEncoding) {
  ...
  EXPECT_THAT(
      absl::BytesToHexString(*ret),
      testing::StrEq(
          "af63626964fa41235c29656e6f6e63657761642d61756374696f6e2d726573756c74"
          ...
          "747470733a2f2f62757965722d6164746563682e636f6d766d6963726f736f667457"
          "696e6e657249734b416e6f6ef4"));
}
...
TEST(ChromeResponseUtils, VerifyMinimalComponentResponseEncodingNoBidCurrency) {
  ...
  EXPECT_THAT(
      absl::BytesToHexString(*ret),
      testing::StrEq(
          "ad63626964fa41235c296573636f7265fa401666666769734368616666f46a61644d"
          ...
          "2d6164746563682e636f6d766d6963726f736f667457696e6e657249734b416e6f6e"
          "f4"));
}
...
TEST(ChromeResponseUtils,
  ...
  EXPECT_THAT(
      absl::BytesToHexString(*ret),
      testing::StrEq(
          "af63626964fa41235c296573636f7265fa401666666769734368616666f46a61644d"
          "657461646174616b61645f6d657461646174616a636f6d706f6e656e7473806b6164"
          "52656e64657255524c781d68747470733a2f2f62757965722d6164746563682e636f"
          ...
          "7965722d6164746563682e636f6d766d6963726f736f667457696e6e657249734b41"
          "6e6f6ef4"));
}
