...
class GenerateBidsReactor
 ...
 private:
  ...
  // Depending on the Interest Group, determines if combination into a single
  // request it possible.
  // TODO(task.ms/53054532): This function should check on a condition in the
  // interest_group and decide whether merging is permitted for said IG. virtual
  virtual bool MicrosoftCanCombineIGsIntoSingleRequest(
