...
class BiddingService final : public Bidding::CallbackService {
 public:
  explicit BiddingService(
      ...
      std::unique_ptr<RoutingUtils> microsoft_routing_utils = nullptr)
#else
      std::unique_ptr<EgressSchemaCache> limited_egress_schema_cache = nullptr)
#endif  // defined(MICROSOFT_AD_SELECTION_BUILD)
...
#if defined(MICROSOFT_AD_SELECTION_BUILD)
        ,
        microsoft_routing_utils_(std::move(microsoft_routing_utils))
#endif  // defined(MICROSOFT_AD_SELECTION_BUILD)
  {
...
#if defined(MICROSOFT_AD_SELECTION_BUILD)
  std::unique_ptr<RoutingUtils> microsoft_routing_utils_;
#endif  // defined(MICROSOFT_AD_SELECTION_BUILD)
};
