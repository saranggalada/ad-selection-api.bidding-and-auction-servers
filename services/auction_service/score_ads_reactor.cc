...
void ScoreAdsReactor::PopulateRelevantFieldsInResponse(
  ...
  // Set K-Anon state of winning Ad. We will let the browser enforce k-anon
  // based on current configurations.
  ad_score.set_microsoft_is_k_anon(
      ad ? ad->microsoft_is_k_anon()
         : protected_app_signals_ad_with_bid->microsoft_is_k_anon());
#endif
