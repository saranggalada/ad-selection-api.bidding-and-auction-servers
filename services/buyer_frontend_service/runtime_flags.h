...
inline constexpr absl::string_view K_ANONYMITY_SERVER_ADDR =
    "K_ANONYMITY_SERVER_ADDR";
inline constexpr absl::string_view K_ANONYMITY_SERVER_TIMEOUT_MS =
...
#if defined(MICROSOFT_AD_SELECTION_BUILD)
  flags.push_back(K_ANONYMITY_SERVER_ADDR);
  flags.push_back(K_ANONYMITY_SERVER_TIMEOUT_MS);
#endif
