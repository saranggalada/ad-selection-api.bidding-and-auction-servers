...
struct GetBidsConfig {
  ...
  // Timeout for communicating with K-Anon service. If this occurs then we will
  // default to NOT k-anon as a privacy preserving default.
  int microsoft_k_anon_timeout_ms;
#endif
